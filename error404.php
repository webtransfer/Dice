...
<div class="row">
		...
		<button onclick="location.href='/'" style="margin-top:25px;color:#fff;background: #303030!important; border: 0px solid; " type="button" class="bg-blue-grey bg-lighten-2  btn  btn-block mr-1 mb-1"> Hа главную</button>
