...
require("inc/bd.php");
$id = $_GET['id'];
	$sql_select = sprintf("SELECT * FROM dice_games WHERE id='%s'", mysql_real_escape_string($id));
...
<link rel="shortcut icon" href="../files/fav_logo.ico" />
    <title>DICE проверка игры №<?php echo $ida; ?></title>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><b>DICE GAME CARD</b><small class="text-muted " style='font-size:90%'> #<?php echo $ida; ?></small></h4>
