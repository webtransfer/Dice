                                            ...
                                            <div class="col-lg-6  col-md-12 col-sm-12 ">
                                                <div id="what-is" class="card" style="border-radius:20px!important;">
                                                    <div  class="card-header"   style="border-radius: 20px!important;">
                                                        <h4 class="card-title"><b>Что такое DICE.24INVEST.BIZ?</b></h4>
...
<div data-menu="menu-container" class="navbar-container main-menu-content container center-layout">
                    ...
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
						...
						<button style="margin-top:12px;margin-left:15px;float:right;" class="flat_button logo_button  color3_bg" onclick="window.open('https://vk.com/dice_pro');">Вконтакте</button>
                    </ul>
                </div>
...
{
	$hashh = $_COOKIE["sid"];
	$sql_select = sprintf("SELECT * FROM dice_users WHERE hash='%s'", mysql_real_escape_string($hashh));
$result = mysql_query($sql_select);
$row = mysql_fetch_array($result);
if($row)
{	
										...
										$.ajax({
                                            ...
                                            <div class="card-body" style="border-radius:20px!important;margin-top:-35px">
                                                <div class="row">
													...
													Введите промокод указанный ниже<br>
													Промокод: BONUS
													<center>
...
$sql_select = "SELECT COUNT(*) FROM dice_payments WHERE user_id='".$userid."'";
$result = mysql_query($sql_select);
$row = mysql_fetch_array($result);
if($row['COUNT(*)'] == 0)
{
...
{
$sql_select33 = "SELECT * FROM dice_payments WHERE user_id='".$userid."' ORDER BY `data` DESC";
...
$sql_select = "SELECT COUNT(*) FROM dice_payout WHERE user_id='".$userid."' ORDER BY `data`";
$result = mysql_query($sql_select);
$row = mysql_fetch_array($result);
if($row['COUNT(*)'] == 0)
{
...
{	
	$sql_select3 = "SELECT * FROM dice_payout WHERE user_id='".$userid."' ORDER BY `data` DESC";
...
do
{
	...
	$payouts = $payouts.'<tr style="cursor:default!important;" id="'.$row3['id'].'"><td>'.$row3['data'].'</td><td><img src="files/qiwi.png"> '.$row3['qiwi'].'</td><td>'.$row3['suma'].' 💵</td>
...
HERE;
$hashh = $_COOKIE["sid"];
	$sql_select = "SELECT * FROM dice_users WHERE hash='$hashh'";
$result = mysql_query($sql_select);
$row = mysql_fetch_array($result);
$prava = $row['prava'];
if($prava == 1)
...
document.getElementById('coinflip').style.display='none';">
                            <a class="dropdown-toggle nav-link"><span>CRASH</span></a>
                        </li>
                        <li class="dropdown nav-item " id="gg" onclick="$('.dsec').hide();$('#realGame').show();$(document.body).removeClass('menu-open');$(window).scrollTop($('#realGame').offset().top);">
                            <a class="dropdown-toggle nav-link"><span>Честная игра</span></a>
...
$bonus10
 ...
 <li data-toggle="modal" data-target="#toperson" style="cursor:pointer; padding-left:3px;">Передать </li> <li data-toggle="modal" data-target="" style="cursor:pointer;"> </li>
                                                                    </ul>
                                                    ...
                                                    <div id="betStart" class="col-lg-4 col-md-6 col-sm-12 ">
                                                        <div class="p-1 text-xs-center" style="margin-top:16px;">
                                                            <div>
                                                                <h3 class="display-4" style="word-wrap:break-word;"><span id="BetProfit" class="display-4 success1 " >2.00</span> 💵</h3>
                                                               
                                                            </div>
<span class="blue-grey darken-1 " style="font-size:17px">Возможный выигрыш</span>
<div style="padding-top:10px;">
<span id="autoclick" onclick="autoclick()" class="tag tag-warning" style="font-size:15px; border-radius:150px;color: #fffff; cursor: pointer">Включить автоклик</span>	<span id="stopauto" onclick="autoclickstop()" class="tag tag-danger" style="font-size:15px;border-radius:150px;display: none; color: #fffff; cursor: pointer;">Отключить автоклик</span>	</div>
                                                            <div class="card-body">
                                                                <div class="row text-xs-center" style="padding-top:10px">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <button onclick="bet('betMin')" id="buttonMin" style="margin-top:5px;color:#fff;border-radius:20px!important; border: 0px solid;box-shadow:rgba(119, 133, 148, 0.73) 7px 10px 23px -11px;background: linear-gradient(to right, rgb(122, 134, 148), rgb(99, 107, 116))!important; " type="button" class="bg-blue-grey bg-lighten-2  btn  btn-block mr-1 mb-1">Меньше</button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 col-xs-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <button onclick="bet('betMax')" type="button" id="buttonMax" style="margin-top:5px;color:#fff; box-shadow:rgba(119, 133, 148, 0.73) 7px 10px 23px -11px; background: linear-gradient(to right, rgb(122, 134, 148), rgb(99, 107, 116))!important;border-radius:150px!important;border: 0px solid " class="bg-blue-grey bg-lighten-2  btn  btn-block mr-1 mb-1">Больше</button>
...
<h1 class="display-4" style="word-wrap:break-word;"><span id="BetProfit" class="display-2 success1" >50</span> <i class="fas fa-chart-line"></i></h1>
                                                              <h3 class="display-4" style="word-wrap:break-word;"><span id="BetProfit" class="display-4 success1 " >50</span> 💵</h3>
...
<div data-menu="menu-container" class="navbar-container main-menu-content container center-layout">
                    ...
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
						...
						<button style="margin-top:12px;float:right;" class="flat_button logo_button  color3_bg" onclick="window.open('https://vk.com/money_game_win');">Мы Вконтакте</button>
                    </ul>
                </div>
                                            ...
                                            <div class="col-lg-6  col-md-12 col-sm-12 ">
                                                <div id="what-is" class="card">
                                                    <div  class="card-header"   style="border-radius: 4px!important;">
                                                        <h4 class="card-title"><b>Что такое SVUTI?</b></h4>
