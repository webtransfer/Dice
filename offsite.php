...
<title>MONEY-WIN - Сервис мгновенных игр, где шанс выигрыша указываете сами.
        </title>
...
<script>
            ...
            $(function() {
				...
				var conn1 = new WebSocket('wss://ws.MONEY-WIN.pro');
...
</center><h2 class=""><b>MONEY-WIN</b></h2></a></center>
</li>
</ul>
</div>
</div>
...
<div class="">
<center>
<a class="btn  btn-block btnError" style="color: rgb(255, 255, 255);width:300px;display: inline-block;margin-top:0;margin-bottom:10px;cursor:pointer!important">НА САЙТЕ ВЕДУТСЯ ТЕХ РАБОТЫ</a><br><a onclick="window.location.replace('http://vk.com/money_game_win');" class="btn  btn-block btnError" style="color: rgb(255, 255, 255); border: 0px solid; box-shadow: rgba(119, 133, 148, 0.73) 7px 10px 23px -11px; max-width:181px;background: linear-gradient(to right, rgb(122, 134, 148), rgb(99, 107, 116)) !important;max-width:181px;display: inline-block;margin-bottom:10px;cursor:pointer!important">Покинуть сайт</a> 
</center>
</div>
<div class="row">
